...
#SBATCH --output=/cluster/home/t922316uhn/PLO/GRIDSS/gridss_\${SAMPLE}_%j.out
#SBATCH --error=/cluster/home/t922316uhn/PLO/GRIDSS/gridss_\${SAMPLE}_%j.err
...
/cluster/home/t922316uhn/gridss/gridss \
  ...
  --threads "\${THREADS}" \
  --log /cluster/home/t922316uhn/PLO/GRIDSS/\${SAMPLE}.gridss.log \
